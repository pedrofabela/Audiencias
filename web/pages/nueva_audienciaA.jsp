                            ...
                            <body id="page-top" onload="startTime()">
                                <s:form name="formularioPrincipal" id="formularioPrincipal">
                                    ...
                                    <nav class="navbar navbar-expand navbar-dark " style="height: 65px; background: #8181a4; box-shadow: 2px 2px 5px #333; border-bottom: 3px solid #cccccc;">
                                        ...
                                        <span class="navbar-brand mr-1" style="font-size: 25px;">Audiencias</span>
                                                        ...
                                                        <div  style="width:99%" >
                                                             ...
                                                             <!-- ++++++++++++++++++++++++++++++++++++++++++++++     -->
                                                                    ...
                                                                    <div class="form-group col-lg-3">
                                                                        ...
                                                                        <div class="col-sm-auto ">
                                                                            <s:select  name="datos.ID_ATIENDE" id="datos.ID_ATIENDE" list="ListaSerPub"  listKey="ID_SERPUB"  listValue="NOMBRE_SERPUB"  headerKey="" headerValue="Servidor Público" cssClass="form-control "  ></s:select>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="form-group col-lg-8">
                                                                                ...
                                                                                <div class="col-sm-auto">
                                                                                      ...
                                                                                      <hr style="width: 99% ; margin: auto; height: 8px; box-shadow: 5px 5pc 15px #333;"/>
                                                                                <s:textarea  cssClass="form-control text-uppercase" name="datos.ASUNTO" id="datos.ASUNTO" maxlength="500"  ></s:textarea>
                                                             ...
                                                             <div style="width:100%; height: 30px; background: #a2a3b8; text-align: center; color:white; margin-top: 15px;   ">
                                                                        ...
                                                                        <table class="table table-hover">
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <s:iterator value="ListaVisitas" id="ListaVisitas" status="stat">
                                                                                    ...
                                                                                    <td style="width: 40%;"><s:property value="ASUNTO" /></td>
