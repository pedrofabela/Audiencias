                                                             ...
                                                             <s:fielderror fieldName="MUNICIPIO" cssClass="alert alert-danger" cssStyle="font-size: 12px; margin-top: 00px; margin-botton:40px;"/>
                                                                        ...
                                                                        <div class="col-sm-auto ">
                                                                            ...
                                                                            <div class="col-sm-auto " style="margin-top: 60px;" >
                                                                                    <a class="btn btn-primary btn-lg" href="Javascript:Accion('guardaCiudadano')" style="background: green; margin-left: 0px;" ><i class="fa fa-user-plus"></i> Guardar y Agregar Audiencia </a>
                                                                            </div>    
                                                                              </s:if>
                                                                            <s:else>
                                                                                
                                                                                <div class="col-sm-auto " style="margin-top: 60px;" >
                                                                                    <a class="btn btn-primary btn-lg" href="Javascript:Accion('agregarAudiencia')" style="background: green; margin-left: 0px;" ><i class="fa fa-user-plus"></i> Agregar Audiencia </a>
                                                                            </div> 
