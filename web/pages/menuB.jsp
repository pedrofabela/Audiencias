            ...
            <s:form name="formularioPrincipal" method="post" id="formularioPrincipal">
                <li class="nav-item active" >
                    <a class="nav-link" style="color: black;" href="Javascript:SeleccionMenu('ReturnStar')">
                        <i class="fas fa-fw fa-home" style="color: #611a1e; font-size: 30px;"></i>
                        <span>Inicio</span>
                    </a>
                </li>
                    ...
                    <s:if test='CVE_MODPADRE=="S"'>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" style="color: black;" href="#" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="fas fa-fw fa-plus-circle" style="color: #611a1e; font-size: 20px;"></i>
                ...
                <li style=" margin-top: 50px;">
                    ...
                    <a href="Javascript:buscar('inicioDashboardFechas')" ><div style="width: 80%; height: 35px; background: purple; margin: auto; margin-top: 40px; color: white; border-radius: 10px; text-align: center; padding: 5px;">Generar</div></a>
                </s:if>
