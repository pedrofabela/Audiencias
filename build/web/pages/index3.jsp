...
function popup(apaterno, amaterno, nombres, telefono, ocupacion, clamun,id, direccion, correo) {
                                                ...
                                                <div  style="width:99%" >
                                                    <div class="modal-content">
                                                        ...
                                                        <div style="width:100%; height: 40px; background: #606060; text-align: center; color:white;   ">
                                                            <h5 style="margin-top: 2px;">Busqueda de Ciudadanos Atención Ciudadana</h5> 
                                                            <br/>
                                                        </div>
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group col-lg-4">
                                                                ...
                                                                <div class="col-sm-auto" style="margin-top: 30px;">
                                                                 ...
                                                                 <div class="" style="margin: auto; width: 100%; margin-top: 20px; ">
                                                                    <a class="btn btn-primary btn-lg" href="Javascript:buscar('busquedaCiudadanoGiras')" style="background: #611a1e; margin: auto; width:100%; border-radius: 30px; " >Buscar</a>
                                                                </div>
                                                            </div>
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <s:iterator value="ListaCiudadanos" id="ListaCiudadanos" status="stat">
                                                                            <tr>
                                                                                ...
                                                                                <td style="width: 10%;" align="center"><a href="Javascript:idCiudadano('nuevaAudienciaGiras','<s:property value="ID" />')"><i class="fa fa-book" style="font-size: 25px; color: #339900;"></i></a></td>
                                                                                <td style="width: 10%; " align="center"><a href="Javascript:popup('<s:property value="APATERNO" />','<s:property value="AMATERNO" />','<s:property value="NOMBRES" />','<s:property value="TELEFONO" />','<s:property value="OCUPACION" />','<s:property value="CLAMUN" />','<s:property value="ID" />','<s:property value="DIRECCION" />','<s:property value="CORREO" />')"><i class="fa fa-pen" style="font-size: 25px; color: gray;"></i></a></td>
                                                                            </tr>
                                                                        </s:iterator>
                                                            ...
                                                            <div id="dvData">
                                                                    ...
                                                                    <div class="form-group col-lg-4">
                                                                       ...
                                                                       <div class="form-group col-lg-4">
                                                                        ...
                                                                        <div class="col-sm-auto ">
                                                                            <s:textfield  cssClass="form-control text-uppercase" name="datos.DIRECCION" id="DIRECCION"  maxlength="200" ></s:textfield>
                                                                        ...
                                                                        <div class="col-sm-auto ">
                                                                            <s:textfield  cssClass="form-control text-uppercase" name="datos.CORREO" id="CORREO"  maxlength="200" ></s:textfield>
                                                                            ...
                                                                            <div class="col-sm-auto " style="margin-top: 60px;" >
                                                                                    <a class="btn btn-primary btn-lg" href="Javascript:validacampos('actualizarCiudadanoGiras')" style="background: green; margin-left: 0px;" ><i class="fa fa-user-plus"></i> Actualizar </a>
                                                                            </div>    
                                                                              </s:if>
                                                                            <s:else>
                                                                                
                                                                                <div class="col-sm-auto " style="margin-top: 60px;" >
                                                                                    <a class="btn btn-primary btn-lg" href="Javascript:validacampos('actualizarCiudadanoGiras')" style="background: green; margin-left: 0px;" ><i class="fa fa-user-plus"></i> Actulizar </a>
                                                                            </div> 
