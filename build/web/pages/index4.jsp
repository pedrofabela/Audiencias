                                                            ...
                                                            <div class="form-group col-lg-4">
                                                                ...
                                                                <div class="col-sm-auto" style="margin-top: 30px;">
                                                                 ...
                                                                 <div class="" style="margin: auto; width: 100%; margin-top: 20px; ">
                                                                    <a class="btn btn-primary btn-lg" href="Javascript:buscar('busquedaCiudadano4')" style="background: #611a1e; margin: auto; width:100%; border-radius: 30px; " >Buscar</a>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <table class="table table-hover">
                                                                <thead style="background: #606060; color: white;">
                                                                    <tr>
                                                                        ...
                                                                        <th style="width: 10%;">Historico</th>
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <s:iterator value="ListaCiudadanos" id="ListaCiudadanos" status="stat">
                                                                            <tr>
                                                                                ...
                                                                                <td style="width: 10%;" align="center"><a href="Javascript:idCiudadano('nuevaAudienciaConsulta','<s:property value="ID" />')"><i class="fa fa-history" style="font-size: 25px; color: #339900;"></i></a></td>
                                                                            </tr>
                                                                        </s:iterator>
