                                                ...
                                                <div  style="width:99%" >
                                                    <div class="modal-content">
                                                        ...
                                                        <div style="width:100%; height: 30px; background: #7025a3;; text-align: center; color:white;   ">
                                                            <h5 style="margin-top: 2px;">Actualizar de Audiencia</h5> 
                                                        ...
                                                        <s:else>
                                                            ...
                                                            <h5 style="margin-top: 2px;">Registro de Audiencia</h5> 
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group col-lg-4">
                                                                <label class="col-form-label " for="domicilio" >Solicita audiencia con</label>
                                                                <div class="col-sm-auto  ">
                                                                    <s:select  name="datos.ID_SERPUB" id="ID_SERPUB" list="ListaSerPub"  listKey="ID_SERPUB"  listValue="NOMBRE_SERPUB"  headerKey="" headerValue="Servidor Público" cssClass="form-control "    ></s:select>
                                                            ...
                                                            <div class="form-group col-lg-6">
                                                                <label class="col-form-label " for="domicilio" >Folio de Referencia</label>
                                                                <div class="col-sm-auto ">
                                                                    <s:textfield list="{'SEDUC'}" cssClass="form-control text-uppercase" name="datos.FOLIO_REFERENCIA" id="FOLIO_REFERENCIA"  maxlength="200" cssStyle=""></s:textfield>
                                                            ...
                                                            <div class="form-group col-lg-6">
                                                                <label class="col-form-label " for="domicilio" >Procedencia</label>
                                                                <div class="col-sm-auto ">
                                                                    <s:textfield list="{'SEDUC'}" cssClass="form-control text-uppercase" name="datos.PROCEDENCIA" id="PROCEDENCIA"  maxlength="200" cssStyle=""></s:textfield>
                                                            ...
                                                            <div class="row">
                                                                <div class="form-group col-lg-8">
                                                                    <label class="col-form-label" for="Apellido Paterno">Asunto</label>
                                                                    <div class="col-sm-auto">
                                                            ...
                                                            <div class="form-group col-lg-4" style="margin-top: 45px; ">
                                                                ...
                                                                <div class="col-sm-auto">
                                                                    ...
                                                                    <div class="col-sm-auto " style="margin: auto;">
                                                                        ...
                                                                        <s:if test="datos.FOLIO.length()>0">
                                                                            <a class="btn btn-primary btn-lg" href="Javascript:Accion('actualizarAudiencia')" style="background: #7025a3;" ><i class="fa fa-user-edit"></i> Actualizar Audiencia</a>
                                                                        </s:if>
                                                                        
                                                                      <s:else>
                                                                        <a class="btn btn-primary btn-lg" href="Javascript:Accion('guardaAudiencia')" style="background: green;" ><i class="fa fa-user-plus"></i> Guardar Audiencia </a>
                                                                   </s:else>
                                                                        
                                                                         <s:if test="mensajeActualiza">
                                                                             <div  style="width: 50%; display: block;  color: green; text-align: center; margin-top: 10px; font-size: 14px;">¡La Audiencia se actualizó con éxito!</div></s:if>
                                                        ...
                                                        <div style="width:100%; height: 30px; background: #606060; text-align: center; color:white; margin-top: 15px;   ">
                                                            <h5 style="margin-top: 2px;">Visitas del Ciudadano </h5> 
                                                            <br/>
                                                        </div>
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <s:iterator value="ListaVisitas" id="ListaVisitas" status="stat">
                                                                            <tr style=" background: #efeaf0; font-size: 12px;">
                                                                                ...
                                                                                <td style="width: 20%;"><s:property value="NOMBRE_SERPUB"/></td>
                                                                                ...
                                                                                <td style="width: 5%;" align="center">
                                                                                    ...
                                                                                    <a href= "<s:property value="myUrl"/>" target="_blank"><img src="images/pdf.png" style="width: 25px; border-radius: 50%; margin-top: 5px;"></img>
                                                                                        ...
                                                                                        <td style="width: 5%; " align="center"><s:if test="GIRAS!=1"><a href="Javascript:popup('consultaFolioActualiza','<s:property value="FOLIO" />')"><i class="fa fa-pen" style="font-size: 25px; color: gray;"></i></a></s:if></td>
